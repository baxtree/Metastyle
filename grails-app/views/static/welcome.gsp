		...
		<div class="template-thumbnails span12 offset2">
			<g:each var="rtempl" in="${ recent }">
				<div id="template-iframe" class="template-group span4">
					<iframe class="template-iframe" src="showSnippet/${ rtempl.id }" frameborder="0" scrolling="no" sandbox="allow-pointer-lock allow-same-origin allow-pointer-lock"></iframe>
					<div class="statistic">
